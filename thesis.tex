...
\usepackage[]{hyperref}
\hypersetup{hypertexnames=false,colorlinks=false,pdfborder={0 0 0},draft=false}%colorlinks=false,pdfborder={0 0 0},hypertexnames=false,draft=false}%draft=false}%hidelinks=true
...
\doublespacing
	...
	\include{1b_theory/theory}	% background information

	\include{3/data}				% Data

	\include{2/method_SMART}		% Methods

	\include{5/results_activity}		%SMART Tracking and Flare association

	\include{6/results_global}			%Global magnetic field results
	
	\include{7/results_diffusion}		%Diffusion tracking results

	\include{8/discussion}			% discussion of results and future direction.
...
%	\include{4/results_uncert}			%SMART uncertainties and simulations (combined into smart method)
